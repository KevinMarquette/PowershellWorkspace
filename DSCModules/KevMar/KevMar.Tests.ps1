#Requires -Modules Pester,xDSCResourceDesigner
...
Describe "DSCResources located in $PSScriptRoot\DSCResources" {
    ...
    foreach($Resource in $ResourceList)
    {
        Context $Resource.name {
            ...
            if ($Resource.name -notmatch "SQLFile|SQLQuery|TCPPrinter|MAPPrinter")
            {
            ...
            It "Has a pester test" {
                ...
                ($Resource.fullname + "\$Resource*.Tests.ps1") | should exist
            }
